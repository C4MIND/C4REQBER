# TURBO-CDI PostgreSQL Production Setup

This guide covers the complete PostgreSQL production setup for TURBO-CDI, including migration from SQLite, connection pooling configuration, and troubleshooting.
...
- [TURBO-CDI Architecture Docs](docs/ARCHITECTURE.md)
