...
replacements = [
    ...
    (
        "src/patterns/library/fractal_mandelbrot.py",
        146,
    ...
    (
        "src/patterns/library/plasma_pic/pattern.py",
        277,
        "(ImportError, AttributeError, RuntimeError)",
    ),
    ...
    (
        "src/patterns/library/cellular_automata.py",
        144,
        "(ImportError, AttributeError, RuntimeError)",
    ),
    ...
    (
        "src/patterns/library/reaction_diffusion.py",
        169,
        "(ImportError, AttributeError, RuntimeError)",
    ),
    ("src/patterns/library/spring_mass.py", 146, "(ImportError, AttributeError, RuntimeError)"),
    (
        "src/patterns/library/circuit_simulation/pattern.py",
        191,
        "(ImportError, AttributeError, RuntimeError)",
    ),
    (
        "src/patterns/library/circuit_simulation/core.py",
        255,
        "(ImportError, AttributeError, RuntimeError)",
    ),
    (
    ...
    (
        "src/patterns/library/signal_transduction/pattern.py",
        228,
        "(ImportError, AttributeError, RuntimeError)",
    ),
    ...
    (
        "src/patterns/library/projectile_motion.py",
        149,
        "(ImportError, AttributeError, RuntimeError)",
    ),
    ...
    (
        "src/patterns/library/enzyme_kinetics/pattern.py",
        211,
        "(ImportError, AttributeError, RuntimeError)",
    ),
    ("src/patterns/library/protein_folding.py", 248, "(ImportError, AttributeError, RuntimeError)"),
    (
        "src/patterns/library/synaptic_plasticity.py",
        276,
        "(ImportError, AttributeError, RuntimeError)",
    ),
    ...
    (
        "src/patterns/library/system_dynamics/core.py",
        204,
        "(ImportError, AttributeError, RuntimeError)",
    ),
    ("src/patterns/library/bootstrap.py", 131, "(ImportError, AttributeError, RuntimeError)"),
    (
        "src/patterns/library/pharmacokinetics.py",
        166,
        "(ImportError, AttributeError, RuntimeError)",
    ),
    ...
    (
        "src/patterns/library/quantum_harmonic_oscillator.py",
        137,
        "(ImportError, AttributeError, RuntimeError)",
    ),
    ...
    (
        "src/patterns/library/population_genetics.py",
        155,
        "(ImportError, AttributeError, RuntimeError)",
    ),
