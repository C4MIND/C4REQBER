...
async def step_synthesis(
    ...
    qzrf_ops: list[str],
    c4_state: C4State,
    isomorphism_found: bool,
    mapping: dict[str, str],
    plugin_results: list[dict[str, Any]] | None,
    provider_router: Any,
    cost_tracker: Any,
    prior_art_confidence: float,
    gap_results: list[dict[str, Any]] | None = None,
    quality_gate_results: dict[str, Any] | None = None,
    max_tokens: int = 1500,
    observer_insights: list[str] | None = None,
    ...
    return await step.execute(
        {
            ...
            "mapping": mapping,
            "observer_insights": observer_insights or [],
            "plugin_results": plugin_results,
            "provider_router": provider_router,
            "cost_tracker": cost_tracker,
            "prior_art_confidence": prior_art_confidence,
