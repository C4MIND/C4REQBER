...
class CFDPattern(SimulationPattern):
    ...
    async def run(  # type: ignore[override]
        ...
        """Execute CFD simulation with Newton (or fallback)."""
        ...
        if bridge.available:
            newton_config = {
                ...
                "reynolds_number": config.get("reynolds_number", 100.0),
        ...
        logger.info(f"Starting CFD simulation {simulation_id} (legacy)")
