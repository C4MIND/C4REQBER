"""
C4REQBER v6.0 - Conflict Pattern
...
class ConflictPattern:
    ...
    def __init__(self, config: ConflictConfig | None = None) -> None:
        ...
        if cfg.model == ConflictModel.SALVO:
            ...
            for step in range(n_steps):
                if cfg.model == ConflictModel.LANCHESTER_LINEAR:
                    ...
                    d_a, d_b = self._lanchester_square_derivatives()  # type: ignore[unreachable]
