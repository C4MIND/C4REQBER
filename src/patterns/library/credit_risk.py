...
class CreditRiskModel:
    ...
    def __init__(self, config: CreditRiskConfig = None) -> None:  # type: ignore[assignment]
        self.config = config or CreditRiskConfig()
        if self.config.confidence_levels is None:
            self.config.confidence_levels = [0.95, 0.99, 0.999]  # type: ignore[unreachable]
    ...
    def credit_migration(self, current_ratings: list[str],
                         migration_matrix: np.ndarray = None) -> dict[str, Any]:  # type: ignore[assignment]
        """
        ...
        if migration_matrix is None:
            ...
            migration_matrix = np.array([  # type: ignore[unreachable]
    ...
    def portfolio_concentration_risk(self, exposures: np.ndarray,
                                      names: list[str] = None) -> dict[str, Any]:  # type: ignore[assignment]
        """
...
class TestCreditRiskModel(unittest.TestCase):
    ...
    """TestCreditRiskModel."""
    def test_merton_distance_to_default(self) -> None:
    ...
    def test_copula_correlation_effect(self) -> None:
    ...
    def test_credit_migration_structure(self) -> None:
    ...
    def test_concentration_metrics(self) -> None:
    ...
    def test_expected_shortfall_greater_than_var(self) -> None:
