...
class FisheriesConfig:
    ...
    # Reference points
    f_msy: float | None = None  # F at MSY
    b_msy: float | None = None  # B at MSY

    # Management
    quota: float | None = None  # Fixed quota
...
class FisheriesPattern(SimulationPattern):
    ...
    async def _schaefer_simulation(self) -> dict[str, Any]:
        ...
        logs = [
            "Schaefer model simulation completed",
    ...
    async def _fox_simulation(self) -> dict[str, Any]:
        ...
        logs = [
            "Fox model simulation completed",
    ...
    async def _age_structured_simulation(self) -> dict[str, Any]:
        ...
        logs = [
            "Age-structured simulation completed",
    ...
    def _calculate_recruitment(self, spawning_biomass: float) -> float:
        ...
        if cfg.recruitment_model == RecruitmentModel.BEVERTON_HOLT:
            ...
            return cfg.alpha * spawning_biomass * np.exp(-cfg.beta * spawning_biomass)  # type: ignore[no-any-return]
