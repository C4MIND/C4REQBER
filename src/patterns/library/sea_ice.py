...
class SeaIcePattern:
    ...
    def __init__(self, config: SeaIceConfig | None = None) -> None:
    ...
    def _update_atmospheric_forcing(self, day: float) -> None:
    ...
    def _dynamics(self) -> tuple[np.ndarray, np.ndarray]:
        ...
        P = cfg.P_star * self.h_ice * np.exp(np.clip(-cfg.C_star * (1 - self.a_ice), -50, 50))
...
class TestSeaIce(unittest.TestCase):
    ...
    def test_albedo_calculation(self) -> None:
    ...
    def test_forcing_update(self) -> None:
