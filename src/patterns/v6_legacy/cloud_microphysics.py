"""
TURBO-CDI v6.0 - Cloud Microphysics Pattern
...
class CloudMicrophysicsPattern:
    ...
    def __init__(self, config: Optional[CloudMicrophysicsConfig] = None):
    ...
    def _format_output(self) -> Dict[str, Any]:
        ...
        total_precip = (
            np.trapz(self.history["precip_rate"], self.history["time"]) / 60
        )  # mm
...
class TestCloudMicrophysics(unittest.TestCase):
    ...
    def test_precipitation_rate(self):
