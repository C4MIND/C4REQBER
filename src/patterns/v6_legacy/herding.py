...
class HerdingModel:
    ...
    def information_cascade(self, private_signals: List[float] = None) -> Dict[str, Any]:
        """
...
if __name__ == "__main__":
    ...
    print(f"  Iterations: {result['opinion_dynamics']['ising']['iterations']}")
