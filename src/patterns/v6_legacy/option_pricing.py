...
class OptionPricingModel:
    ...
    def __init__(self, config: OptionPricingConfig = None):
    ...
    def monte_carlo(
        self, n_simulations: int = None, antithetic: bool = True
    ) -> Dict[str, Any]:
        """
    ...
    def sensitivity_analysis(self) -> Dict[str, List]:
        ...
        return {
            "stock_price": {"parameter": S_range.tolist(), "price": prices_S},
            "volatility": {"parameter": sigma_range.tolist(), "price": prices_sigma},
            "time_to_maturity": {"parameter": T_range.tolist(), "price": prices_T},
            "interest_rate": {"parameter": r_range.tolist(), "price": prices_r},
        }
