...
class RigidBody(BasePattern, GPUMixin):
    ...
    def __init__(self, config: Optional[RigidBodyConfig] = None):
    ...
    def _integrate_quaternion(self, body: BodyState, dt: float):
    ...
    def _check_collision(self, body: BodyState) -> Optional[Dict[str, Any]]:
    ...
    def _solve_contact(self, collision: Dict[str, Any]):
