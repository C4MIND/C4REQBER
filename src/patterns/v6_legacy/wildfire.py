"""
TURBO-CDI v6.0 - Wildfire Pattern
...
class WildfirePattern:
    ...
    def __init__(self, config: Optional[WildfireConfig] = None):
    ...
    def _rothermel_ros(self, slope_factor: float = 1.0) -> float:
        ...
        return max(ros, 0.1)  # Minimum ROS
    ...
    def _spotting(self, burning_cells: List[Tuple[int, int]], time: float):
    ...
    def _crown_fire_transition(self):
    ...
    def _suppression(self, time: float):
