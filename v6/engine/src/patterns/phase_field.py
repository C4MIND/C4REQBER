...
class PhaseFieldPattern(SimulationPattern):
    ...
    def __init__(self):
        ...
        self.config: Optional[PhaseFieldConfig] = None
    ...
    async def _simulate(self, hypothesis: Hypothesis) -> Dict[str, Any]:
        ...
        # Fourier grid
        k = 2 * np.pi * fftfreq(N, self.config.dx)
    ...
    def _chemical_potential(self, phi: np.ndarray, epsilon: float) -> np.ndarray:
        ...
        return f_prime - epsilon**2 * laplacian
    ...
    def _analyze_results(self) -> Dict[str, Any]:
        ...
        logs = [
            f"Phase Field simulation: {self.config.grid_size}×{self.config.grid_size}",
